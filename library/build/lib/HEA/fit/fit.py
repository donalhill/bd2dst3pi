...
def crystall_ball_or_gaussian(mu, sigma, obs, alpha=None, n=None):
    ...
    alpha: zfit.Parameter
        alpha parameter of the tail
    n: zfit.Parameter
        n parameter of the tail
...
def sum_crystalball_or_gaussian(muL, muR, sigmaL, sigmaR, frac, obs, alphaL=None, alphaR=None, nL=None, nR=None):
    ...
    alphaL: zfit.Parameter
        alpha parameter of the left tail of the left distribution
    alphaR: zfit.Parameter
        alpha parameter of the left tail of the right distribution
    nL: zfit.Parameter
        n parameter of the left tail of the left distribution
    nL: zfit.Parameter
        n parameter of the right tail of the right distribution
...
def define_zparams(initial_values, cut_BDT=None, num=None):
    ...
    num            : integer
        ...
        the other functions I wrote allow to ignore the ';{num}' in the name of the variable
...
def save_params(params, name_file, uncertainty=True, dic_add=None, folder_name=None, remove=None):
    """ Save the parameters of the fit in {loc['json']}/{name_file}_params.json
    
    Parameters
    ----------
    params        : dict[zfit.zfitParameter, float]
        Result 'result.params' of the minimisation of the loss function (given by launch_fit)
    name_file     : Str
    ...
    remove        : list[Str] or str or None
        if not None, string to be removed from 
