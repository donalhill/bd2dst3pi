...
def plot_xys (ax, x, ly, xlabel, labels=None, colors=['b','g','r','y'], fontsize=default_fontsize['label'], markersize=1,
             linewidth=1., linestyle='-', factor_ymax=1., marker='.', elinewidth=None,
              annotations=None, fontsize_annot=default_fontsize['annotation'], 
...
def plot_x_list_ys(x, y, name_x, names_y, latex_name_x=None, latex_names_y=None, 
    ...
    latex_names_y    : str or list(str)
        surname of each list in l_y - use for labelling each curve
    fig_name         : str
