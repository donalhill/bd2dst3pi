...
def _assert_same_length(*args):
    """ Assert that all the python elements provided have the same length
    ...
    *args: list of python objects
    ...
    for arg in args[1:]:
        assert len(arg)==common_length, f"The length of {arg} is different from the other lengths of the list \n {args}"
